...
form.addEventListener('submit', function (event) {
    event.preventDefault(); const inputText = reportInput.value; if (inputText.trim() === "") return;
